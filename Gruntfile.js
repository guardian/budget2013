...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		guid: '7c0b36c7-f347-421c-940e-2287fdd3c2fb',

		baseUrl: 'http://interactive.guim.co.uk',

		projectPath: '2013/mar/budget',
			...
			buildIndex: {
				...
				options: {
					variables: {
						...
						boot_js: '<%= projectUrl %>/boot.js',
						boot_css: '<%= projectUrl %>/boot.css'
					}
				}
			},
			devIndex: {
		...
		fetch: {
			budget2013: {
				url: 'https://docs.google.com/spreadsheet/pub?key=0AgS_UxBggDCMdEJiamhMOHBma3VIeWdtZlY4OXdldWc&output=csv',
				dest: 'project/gubbins/2013/data.json',
				options: {
		...
		render: {
			options: {
				sourceTemplate: 'project/gubbins/templates/source.html',
				annotationTemplate:  'project/gubbins/templates/annotation.html'
			},
			budget2012: {
				files: {
					'project/codeobject.html': 'project/gubbins/2013/data.json'
				}
			}
		}
	});
