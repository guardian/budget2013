...
(function () {
	...
	// Load project CSS
	LazyLoad.css( 'http://interactive.guim.co.uk/2013/mar/budget/v/22/min.css' );
	...
	// During development, we want to use local copies of jQuery and RequireJS
		...
		scripts = [
			'http://interactive.guim.co.uk/2013/mar/budget/v/22/js/lib/jquery.js',
			'http://interactive.guim.co.uk/2013/mar/budget/v/22/js/require.js'
		];
	}

	// Load non-bundled dependencies, then start our app
	LazyLoad.js( scripts, function () {
		LazyLoad.js( 'http://interactive.guim.co.uk/2013/mar/budget/v/22/js/main.js' );
	});
